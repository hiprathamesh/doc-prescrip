        ...
        <div className="space-y-3 animate-in fade-in duration-400">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-3 border border-gray-300 dark:border-gray-700 hover:border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-200 focus:border-blue-400 transition-colors"
              autoFocus
            />
          </div>

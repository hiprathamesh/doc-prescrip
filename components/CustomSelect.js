...
export default function CustomSelect({ options, value, onChange, placeholder, onAddNew }) {
  ...
  return (
    <div className="relative w-full" ref={wrapperRef}>
      ...
      {isOpen && (
        <div className="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-60 rounded-lg py-1 text-base  overflow-auto focus:outline-none sm:text-sm border border-gray-200">
          <div className="p-2">
            <input
              ref={inputRef}
              type="text"
